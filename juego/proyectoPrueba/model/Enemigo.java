...
public class Enemigo extends ObjetoGraficoMovil {
    ...
    public Enemigo() {
        super(new Circulo(new Color(255, 255, 255), new Punto(POS_ENEMIGO_INICIAL_X, POS_ENEMIGO_INICIAL_Y), RADIO), 0, 0);
    ...
    public void avanzar() {
        ...
        // Si la distancia entre enemigo y heroe es mayor que 30, el enemigo persigue al heroe
        if(distancia > 30){
        ...
        // Y si es menor que 20 el enemigo se aleja del heroe
            ...
            setIncX(-VELOCIDAD * (xHeroe-xEnemigo)/distancia);
            setIncY(-VELOCIDAD * (yHeroe-yEnemigo)/distancia);
        // En otro caso, es decir, si la distancia está entre 20 y 30, se queda en la misma posición
        }else{ 
            setIncX(0);
            setIncY(0);
        }
